    ...
    <div class="top-bar flex">
        ...
        <div class="menu-box-1 flex con flex-ai-c flex-jc-e">
            <ul class="flex">
                ...
                <li class="flex"><a href="#">SERVICES</a></li>
                <li class="flex"><a href="#">PR</a></li>
                <li class="flex"><a href="#">IR</a></li>
                <li class="flex"><a href="#">RECRUIT</a></li>
                <li class="flex"><a href="#">INSIDE NHN</a></li>
            </ul>
        </div>
        <div class="language flex con flex-ai-c ">
            <ul class="flex">
